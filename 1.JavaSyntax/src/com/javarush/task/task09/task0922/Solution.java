...
public class Solution {
    ...
    public static void main(String[] args) throws Exception {
        ...
        SimpleDateFormat formatAfter = new SimpleDateFormat("MMM dd, yyyy", Locale.ENGLISH);

        Date date = formatBefore.parse(reader.readLine());

        System.out.println(formatAfter.format(date).toUpperCase());
    }
}
